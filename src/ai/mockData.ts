...
export const MOCK_SCENES: Record<string, Scene[]> = {
  ...
  'room-puzzle': [
    mk(
      'room-puzzle',
      'The Whispering Bridge. Four planks: T, R, U, E. The wind hums a word. Which plank leads across?',
      {
        id: 'c1',
        label: 'Choose T',
        stat: 'int',
        target: 12,
        success: 'TRUE — the plank hums approval and glows warm. You cross safely.',
      ...
      },
      {
        ...
        stat: 'int',
        target: 12,
        success: 'The R plank sings for a moment, then lifts you gently across.',
      ...
      },
      {
        ...
        stat: 'int',
        target: 12,
        success: 'The plank holds! You glide across the ravine.',
        failure: 'You wobble, catch yourself. Try again next turn.',
        damage: 1,
      },
      'Place four small paper planks labelled T, R, U, E on the board.',
